package com.albee.mydatagwtestdriver.config;
...
@MapperScan(value = {"com.albee.mydatagwtestdriver.api.*.*.repository"})
public class DataSourceConfig {
    ...
    public SqlSessionFactory sqlSessionFactory(DataSource dataSource) throws Exception {
        ...
        sqlSessionFactoryBean.setTypeAliasesPackage("com.albee.mydatagwtestdriver");
