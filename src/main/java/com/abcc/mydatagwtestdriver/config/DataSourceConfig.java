package com.abcc.mydatagwtestdriver.config;
...
@MapperScan(value = {"com.abcc.mydatagwtestdriver.api.*.*.repository"})
public class DataSourceConfig {
    ...
    public SqlSessionFactory sqlSessionFactory(DataSource dataSource) throws Exception {
        ...
        sqlSessionFactoryBean.setTypeAliasesPackage("com.abcc.mydatagwtestdriver");
