package com.kpcnc.mydatagwtestdriver.config;
...
@MapperScan(value = {"com.kpcnc.mydatagwtestdriver.api.*.*.repository"})
public class DataSourceConfig {
    ...
    public SqlSessionFactory sqlSessionFactory(DataSource dataSource) throws Exception {
        ...
        sqlSessionFactoryBean.setTypeAliasesPackage("com.kpcnc.mydatagwtestdriver");
